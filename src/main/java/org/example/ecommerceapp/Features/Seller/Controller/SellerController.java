package org.example.ecommerceapp.Features.Seller.Controller;
...
public class SellerController {
	...
	@PutMapping("/seller")
	public ResponseEntity<?> updateCustomer(@RequestBody @Valid UserDTO userInfo, @RequestParam String key) throws Exception {
		Integer currentLogin = Integer.valueOf(String.valueOf(loginService.validateToken(key)));
		Seller updatedSeller = sellerService.updateSeller(userInfo, currentLogin);
